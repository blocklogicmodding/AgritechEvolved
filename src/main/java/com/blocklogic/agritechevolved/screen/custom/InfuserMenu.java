...
public class InfuserMenu extends AbstractContainerMenu {
    ...
    public InfuserMenu(int containerId, Inventory inv, BlockEntity blockEntity) {
        super(ATEMenuTypes.INFUSER_MENU.get(), containerId);
        ...
        this.addSlot(new SlotItemHandler(this.blockEntity.inventory, 12, 98, 33)); // Farmland Input Slot
        this.addSlot(new SlotItemHandler(this.blockEntity.inventory, 13, 134, 15)); // Output Slot
        this.addSlot(new SlotItemHandler(this.blockEntity.inventory, 14, 134, 51)); // Module Slot 1
